...
public class BlockElectricMotor extends BlockHorizontal {
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
        ...
        playerIn.openGui(DVeins.instance, 1, worldIn, pos.getX(), pos.getY(), pos.getZ());
        return true;
    }
    ...
    public void addInformation(ItemStack itemStack, @Nullable World world, List<String> currentTooltip, ITooltipFlag flag) {
        ...
        String[] parts = I18n.format("description.electric_motor", ModConfig.electricMotor.rf_per_tick).split("\\\\n");
