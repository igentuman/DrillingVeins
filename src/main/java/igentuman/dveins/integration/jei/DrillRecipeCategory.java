...
public class DrillRecipeCategory implements IRecipeCategory<DrillRecipeCategory.Wrapper>
{
    private static final ResourceLocation GUI_LOCATION = new ResourceLocation(MODID, "textures/gui/jei/drill.png");
    private static final String TRANSLATION_KEY = "dveins.jei.category.drill";

    private final IDrawable background;
    private final IDrawableAnimated animatedArrow;

    public DrillRecipeCategory(IGuiHelper guiHelper)
    {
    ...
    public static class Wrapper implements IRecipeWrapper
    {
        ...
        public Wrapper(IRecipe recipe)
        {
            ...
            // Add the ingredient
            //builder.add(recipe.getIngredients());
