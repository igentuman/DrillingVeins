...
import igentuman.dveins.util.NCUtil;
import igentuman.dveins.util.PermutationHelper;
...
@ZenClass("mods.dveins.BasicRecipeHandler")
@ZenRegister
public abstract class BasicRecipeHandler extends AbstractRecipeHandler<BasicRecipe> {
	...
	public void addRecipe(Object... objects) {
		...
		addRecipe(true ? factorRecipe(recipe) : recipe);
	}
